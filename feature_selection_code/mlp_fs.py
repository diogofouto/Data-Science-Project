...
def main():
    ...
    for (filename_train, filename_test, filetag, target) in [
            ...
            ('NYC_collisions_train_smote_no_low_variance_vars_no_correlated_vars_0.0', 'NYC_collisions_test_no_low_variance_vars_no_correlated_vars_0.0', 'No_correlated_vars_0.0', NYC_TARGET),
    ...
    plt.savefig('images/lab6/feature_selection/NYC_collisions_correlation_mlp_study', dpi=300, bbox_inches="tight")
    plt.clf() # cleanup
