...
collisions_data = pd.read_csv(COLLISIONS_FILE, index_col="COLLISION_ID", na_values='', parse_dates=True, infer_datetime_format=True).drop(["UNIQUE_ID", "VEHICLE_ID"], axis=1)
...
def fit_distributions(data, path):
    ...
    splits = np.array_split(numeric_vars, 26)
...
# %%
fit_distributions(collisions_data, "images/lab1/distribution/nyc_crashes_histograms_fits")
#%%
"""
---------- SYMBOLIC VARIABLES ----------
